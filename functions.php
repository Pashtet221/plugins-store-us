...
/**
 * Место для CAPTCHA перед кнопкой формы без переопределения шаблона.
 */
function ps_render_plugin_comment_captcha_slot() {
	if (is_singular('plugin')) {
		do_action('plugins_store_comment_captcha');
	}
}
add_action('comment_form_before_submit', 'ps_render_plugin_comment_captcha_slot');
...
function ps_enqueue_plugin_discussion_styles() {
	...
	$css = '.ps-plugin-discussion{padding:64px 0;background:#fff;color:#0f172a}.ps-plugin-discussion .container{box-sizing:border-box;padding-left:20px;padding-right:20px}.ps-plugin-discussion__inner{max-width:900px;margin:0 auto;padding:34px;border:1px solid rgba(15,23,42,.08);border-radius:28px;background:#fff;box-shadow:0 18px 50px rgba(15,23,42,.06)}.ps-plugin-discussion__heading{margin-bottom:28px;padding-bottom:24px;border-bottom:1px solid rgba(15,23,42,.08)}.ps-plugin-discussion__heading-row{display:flex;align-items:center;gap:12px}.ps-plugin-discussion__heading h2{margin:0 0 12px;color:#0f172a;font-size:clamp(28px,3vw,40px);line-height:1.15}.ps-plugin-discussion__count{display:inline-flex;align-items:center;justify-content:center;min-width:30px;height:30px;margin-bottom:12px;padding:0 9px;border-radius:999px;background:#eef2ff;color:#4d3bfe;font-weight:800}.ps-plugin-discussion__heading p{margin:0;color:#64748b;font-size:17px;line-height:1.65}.ps-plugin-discussion .comment-list{margin:0 0 34px;padding:0;list-style:none}.ps-plugin-discussion .comment-list .children{margin:20px 0 0 32px;padding:0;list-style:none}.ps-plugin-discussion .comment-body{display:grid;grid-template-columns:60px minmax(0,1fr);column-gap:14px;margin-bottom:18px;padding:22px;border-radius:18px;background:#f8fafc}.ps-plugin-discussion .comment-avatar{position:static;grid-row:1/span 3;float:none;width:60px;margin:0}.ps-plugin-discussion .comment-avatar img{display:block;width:60px;height:60px;border-radius:50%}.ps-plugin-discussion .comment-meta{min-width:0;min-height:0}.ps-plugin-discussion .comment-author{color:#0f172a;font-style:normal;font-weight:800}.ps-plugin-discussion .comment-time{display:block;margin-left:0;color:#94a3b8;font-size:13px}.ps-plugin-discussion .comment-content{clear:none;padding-top:12px;color:#334155;line-height:1.7}.ps-plugin-discussion .reply{margin-top:12px;color:#4d3bfe;font-weight:700;cursor:pointer}.ps-plugin-discussion .comment-reply-link{opacity:1}.ps-plugin-discussion .comment-reply-title{margin:0 0 18px;font-size:24px;font-weight:800}.ps-plugin-discussion .comment-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.ps-plugin-discussion .comment-form p{float:none;width:auto;margin:0}.ps-plugin-discussion .comment-form-comment,.ps-plugin-discussion .form-submit,.ps-plugin-discussion .logged-in-as,.ps-plugin-discussion .comment-notes,.ps-plugin-discussion .comment-form-cookies-consent{grid-column:1/-1}.ps-plugin-discussion label:not(.screen-reader-text){display:block;margin-bottom:7px;color:#334155;font-size:14px;font-weight:700}.ps-plugin-discussion input[type=text],.ps-plugin-discussion input[type=email],.ps-plugin-discussion textarea{box-sizing:border-box;width:100%;padding:14px 16px;border:1px solid #cbd5e1;border-radius:12px;background:#fff;color:#0f172a}.ps-plugin-discussion textarea{min-height:150px;resize:vertical}.ps-plugin-discussion input:focus,.ps-plugin-discussion textarea:focus{outline:2px solid rgba(77,59,254,.2);border-color:#4d3bfe}.ps-plugin-discussion .submit{min-height:50px;padding:0 22px;border:0;border-radius:12px;background:#4d3bfe;color:#fff;font-weight:800;cursor:pointer}.ps-plugin-discussion .submit:hover{background:#3927db}.ps-plugin-discussion__closed{margin:0;color:#64748b}@media(max-width:640px){.ps-plugin-discussion{padding:44px 0}.ps-plugin-discussion .container{padding-left:16px;padding-right:16px}.ps-plugin-discussion__inner{padding:22px}.ps-plugin-discussion .comment-form{grid-template-columns:1fr}.ps-plugin-discussion .comment-list .children{margin-left:14px}.ps-plugin-discussion .comment-body{grid-template-columns:44px minmax(0,1fr);column-gap:12px;padding:18px}.ps-plugin-discussion .comment-avatar,.ps-plugin-discussion .comment-avatar img{width:44px;height:44px}}';
